...
import { LinkElementsSet } from "./fixtures/linkElementsSet";
import { LinkElementProps } from "./fixtures/linkElementProps";

describe('LinkTag', function () {

    const linkElementsSet = new LinkElementsSet();
    const sameLink = Toolbelt.Head.LinkTag.sameLink;

    function createLink(props: LinkElementProps): Toolbelt.Head.LinkElement {
